<h2><a href="https://www.geeksforgeeks.org/problems/overlapping-intervals--170633/1?page=1&category=Sorting&company=Amazon,Microsoft,Flipkart,Adobe,Google,Samsung,Paytm,Morgan%20Stanley,BankBazaar&difficulty=Medium&status=unsolved&sortBy=submissions">Overlapping Intervals</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a collection of Intervals, the task is to merge all of the overlapping Intervals.</span></p>
