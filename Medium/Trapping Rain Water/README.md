<h2><a href="https://www.geeksforgeeks.org/problems/trapping-rain-water-1587115621/1?page=1&category=Dynamic%20Programming&company=Amazon,Microsoft,Flipkart,Adobe,Google,Samsung,Accolite,MakeMyTrip,Snapdeal,Paytm,Goldman%20Sachs,Morgan%20Stanley,Walmart,OYO%20Rooms,D-E-Shaw,FactSet,Ola%20Cabs,Oracle,MAQ%20Software,Facebook,VMWare,SAP%20Labs,Hike,Qualcomm,Intuit,Cisco,Visa,Directi,Linkedin,Yahoo,Payu,Wipro,Atlassian,Infosys,Uber&difficulty=Medium&status=unsolved&sortBy=submissions">Trapping Rain Water</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>&nbsp;of <strong>N</strong> non-negative integers representing the height of blocks. If&nbsp;width of each block is 1, compute how much water can be trapped&nbsp;between the blocks during the rainy season.&nbsp;</span><br>&nbsp;</p>
